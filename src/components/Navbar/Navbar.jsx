...
function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 w-full  z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-transparent"}`}>
      <div className='text-white py-4 flex justify-between items-center text-lg'>
        ...
        <div className='hidden md:flex space-x-4'>
          <a
            href='https://github.com/chiragvaghela1008'
            target="_blank"
          ...
          <a
            href='https://www.linkedin.com/in/chirag-vaghela-9b335123b/'
            target="_blank"
            rel='noopener noreferrer'
            className='text-gray-300 hover:text-[#8245ec]'
          >
      ...
      {/*mobile menu items*/}
      {isOpen && (
        <div className='absolute top-15 left-1/2 transform -translate-x-1/2 w-4/5 bg-[#050414] bg-opacity-50 backdrop-filter backdrop-blur-lg z-50 rounded-lg shadow-lg'>
